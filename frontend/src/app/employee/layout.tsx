...
function SidebarContent({ onNavigate }: { onNavigate?: () => void }) {
  ...
  return (
    <div className="flex h-full flex-col gap-6 p-5">
      <Link href="/employee" onClick={onNavigate} className="flex items-center gap-2 px-1 font-serif text-lg text-white">
  ...
  return (
    <div className="flex min-h-screen bg-cream-200">
      ...
      <div className="fixed inset-x-0 top-0 z-40 flex h-14 items-center justify-between border-b border-black/10 bg-green-950 px-4 lg:hidden">
        ...
        <Link href="/employee" className="flex items-center gap-2 font-serif text-base text-white">
