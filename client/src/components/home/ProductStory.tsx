...
const FALLBACK_IMAGE = "/images/editorial/mariyam-dates.webp";
const FALLBACK_TITLE = "The Essence of Madinah";
...
export function ProductStory({ section }: { section?: ApiHomepageSection }) {
  const image = section?.image?.url ?? FALLBACK_IMAGE;
