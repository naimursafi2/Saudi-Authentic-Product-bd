...
export function Modal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      <button aria-label="Close" className="absolute inset-0 bg-green-950/40" onClick={onClose} />
      <div
      ...
      >
        <div className="flex items-center justify-between border-b border-brown-600/10 px-6 py-4">
          ...
          <button aria-label="Close" onClick={onClose} className="text-brown-500 hover:text-green-950">
            <X size={18} />
          </button>
        </div>
